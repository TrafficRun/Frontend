...
import neighbour from '../data/neighbour.json'
import drivePath from '../data/drive_path_v4.json'
...
export const ManhattanRun : RealModel<Array<number>> = new RealModel(formatStreets, points, requests, driveKeyPoint, neighbour, drivePath)
